...
|---|---|---|---|
| `mysql-test/suite/perfschema/r/dml_handler.result` | Batch 1 | pending | Non-preserve-suite P_S result; migrate with empty P_S preserved-transactions surface and run targeted `perfschema.dml_handler`. |
