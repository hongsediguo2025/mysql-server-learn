...
SHOW_VAR status_vars[] = {
    ...
    {"Preserve_trx_resume_real_redo_apply",
     ...
     SHOW_SCOPE_GLOBAL},
    {"Preserve_trx_resume_real_ha_promotion",
     (char *)&show_preserve_trx_resume_real_ha_promotion, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    ...
    {"Preserve_trx_transfer_receiver_staged_token_publish_us",
     (char *)&show_preserve_trx_transfer_receiver_staged_token_publish_us,
     SHOW_FUNC, SHOW_SCOPE_GLOBAL},
